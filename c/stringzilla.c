...
__declspec(allocate(".CRT$XCS")) void (*sz_dispatch_table_init_)(void) = sz_dispatch_table_init;
...
SZ_DYNAMIC int sz_version_major(void) { return STRINGZILLA_VERSION_MAJOR; }
SZ_DYNAMIC int sz_version_minor(void) { return STRINGZILLA_VERSION_MINOR; }
SZ_DYNAMIC int sz_version_patch(void) { return STRINGZILLA_VERSION_PATCH; }
